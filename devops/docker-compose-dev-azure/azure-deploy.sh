...
resourcename="shoppingcartnodate"  # lower case, only
resourcegroup="shoppingcartnodate_rg"
...
# git clone https://github.com/apilogicserver/shoppingcartnodate.git
# cd shoppingcartnodate
...
az group create --name shoppingcartnodate_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group shoppingcartnodate_rg --sku S1 --is-linux
az container create --resource-group shoppingcartnodate_rg --name shoppingcartnodate --image apilogicserver/shoppingcartnodate:latest --dns-name-label shoppingcartnodate --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//shoppingcartnodate.westus.azurecontainer.io:5656'
