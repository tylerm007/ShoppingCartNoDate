...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.Coupon, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.WishlistItem, method_decorators= method_decorators)
    return api
